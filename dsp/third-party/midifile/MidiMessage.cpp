...
//////////////////////////////
//
// MidiMessage::setParamValueeters -- Set the second and optionally the
...
void MidiMessage::setParamValueeters(int p1) {
...
void MidiMessage::setParamValueeters(int p1, int p2) {
	int oldsize = (int)size();
	resize(3);
	(*this)[1] = (uchar)p1;
	(*this)[2] = (uchar)p2;
